...
import com.simbircite.secretary.model.Restorable;
import com.simbircite.secretary.model.User;
import com.simbircite.secretary.service.EncryptService;
import com.simbircite.secretary.service.KeyGenerationService;
import com.simbircite.secretary.service.UserService;
...
public class UserController {
	...
	public String register(
			@Valid @ModelAttribute(MODEL) User auth,
		...
		String url = request.getRequestURL() + "/" + user.getCode();
		msg.setText("Click on this link to confirm your registration: " + url);
	...
	public String restore(
			@Valid @ModelAttribute(MODEL) Restorable auth,
